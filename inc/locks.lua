...
else redis:set(syria..'lock_woring'..msg.chat_id_,true)
...
if not msg.Admin then return "💥*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(syria..'lock_woring'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*التحذير بالتأكيد معطل\n✓" 
else
redis:del(syria..'lock_woring'..msg.chat_id_) 
...
if not msg.Admin then return "💥*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(syria..'lock_id'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*الايدي بالتأكيد معطل\n✓" 
else
redis:del(syria..'lock_id'..msg.chat_id_) 
...
redis:set(syria..'lock_id'..msg.chat_id_,true)  
...
else redis:set(syria..'welcome:get'..msg.chat_id_,true)  
...
if not msg.Admin then return "💥*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(syria..'welcome:get'..msg.chat_id_) then 
...
syria..'mute_gif'..msg.chat_id_,true,
syria..'mute_photo'..msg.chat_id_,true,
syria..'mute_audio'..msg.chat_id_,true,
syria..'mute_voice'..msg.chat_id_,true,
syria..'mute_sticker'..msg.chat_id_,true,
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:del(
syria..'lock_username'..msg.chat_id_,
syria..'mute_gif'..msg.chat_id_,
syria..'mute_photo'..msg.chat_id_,
syria..'mute_audio'..msg.chat_id_,
syria..'mute_voice'..msg.chat_id_,
syria..'mute_sticker'..msg.chat_id_,
syria..'mute_forward'..msg.chat_id_,
syria..'mute_contact'..msg.chat_id_,
syria..'mute_location'..msg.chat_id_,
syria..'mute_document'..msg.chat_id_,
syria..'lock_link'..msg.chat_id_,
syria..'lock_tag'..msg.chat_id_,
syria..'lock_edit'..msg.chat_id_,
syria..'lock_spam'..msg.chat_id_,
syria..'lock_bots'..msg.chat_id_,
syria..'lock_webpage'..msg.chat_id_,
syria..'mute_video'..msg.chat_id_,
syria..':tqeed_video:'..msg.chat_id_,
syria..':tqeed_photo:'..msg.chat_id_,
syria..':tqeed_gif:'..msg.chat_id_,
syria..':tqeed_fwd:'..msg.chat_id_,
syria..':tqeed_link:'..msg.chat_id_,
syria..'mute_inline'..msg.chat_id_
)
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*تــ✓ــم فتح الكل  \n✓"
end
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(syria..':tqeed_photo:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالصور بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(syria..'mute_photo'..msg.chat_id_)
redis:set(syria..':tqeed_photo:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(syria..':tqeed_photo:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالصور بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(syria..':tqeed_photo:'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(syria..':tqeed_video:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالفيديو بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(syria..':tqeed_video:'..msg.chat_id_)
redis:set(syria..':tqeed_video:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(syria..':tqeed_video:'..msg.chat_id_) then
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(syria..':tqeed_gif:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد الممتحركه بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(syria..'mute_gif'..msg.chat_id_)
redis:set(syria..':tqeed_gif:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(syria..':tqeed_gif:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد المتحركه بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(syria..':tqeed_gif:'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(syria..':tqeed_fwd:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالتوجيه بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(syria..'mute_forward'..msg.chat_id_)
redis:set(syria..':tqeed_fwd:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(syria..':tqeed_fwd:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد التوجيه بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(syria..':tqeed_fwd:'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(syria..':tqeed_link:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالروابط بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(syria..':tqeed_link:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(syria..':tqeed_link:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالروابط بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(syria..':tqeed_link:'..msg.chat_id_)
...
if redis:get(syria..'lock_twasel') then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التواصل بالتاكيد تــ✓ــم تعطيله \n✓'
else
redis:set(syria..'lock_twasel',true)
...
if not redis:get(syria..'replay'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الردود بالتاكيد تــ✓ــم تعطيله \n✓'
else
redis:del(syria..'replay'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'replay'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الردود بالتاكيد تــ✓ــم تفعيله \n✓'
else 
redis:set(syria..'replay'..msg.chat_id_,true)
...
if not msg.SudoBase then return "🚸*│*هذا الامر يخص المطور الاساسي فقط  \n💥" end
if not redis:get(syria..'lock_service') then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم بالتاكيد تعطيل نظام البوت خدمي \n✓'
else
redis:del(syria..'lock_service')
...
redis:set(syria..'lock_service',true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'lock_link'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الروابط بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(syria..'lock_link'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الروابط \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'lock_link'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الروابط بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(syria..'lock_link'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الروابط \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'lock_tag'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التاك (#) بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(syria..'lock_tag'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التاك (#) \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'lock_tag'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التاك(#) بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(syria..'lock_tag'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح التاك (#) \n✓'
end
end
---------------Lock UserName-------------------
...
if redis:get(syria..'lock_username'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*المعرفات @ بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(syria..'lock_username'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'lock_username'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*آلمـعرفآت بآلتآگيد تــ✓ــم فتحهآ @ \n✓'
else 
redis:del(syria..'lock_username'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'lock_edit'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التعديل بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(syria..'lock_edit'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التعديل \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'lock_edit'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التعديل بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(syria..'lock_edit'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح التعديل \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if   redis:get(syria..'lock_spam'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكلايش بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(syria..'lock_spam'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الكلايش \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'lock_spam'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكلايش بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(syria..'lock_spam'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الكلايش \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'lock_flood'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التكرار بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(syria..'lock_flood'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التكرار \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'lock_flood'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التكرار بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(syria..'lock_flood'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح التكرار \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'lock_bots'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البوتات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(syria..'lock_bots'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل البوتات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'lock_bots'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البوتات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(syria..'lock_bots_by_kick'..msg.chat_id_)
redis:del(syria..'lock_bots'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح البوتات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'lock_join'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الاضافه بالتاكيد تــ✓ــم قفلها \n✓'
else
redis:set(syria..'lock_join'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الاضافه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'lock_join'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الاضافه بالتاكيد تــ✓ــم فتحها \n✓'
else 
redis:del(syria..'lock_join'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الاضافه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'lock_markdown'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الماركدوان بالتاكيد تــ✓ــم قفله \n✓'
else
redis:set(syria..'lock_markdown'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'lock_markdown'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الماركدوان بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(syria..'lock_markdown'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'lock_webpage'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الويب بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(syria..'lock_webpage'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الويب \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'lock_webpage'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الويب بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(syria..'lock_webpage'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الويب \n✓'
end
end
---------------Mute Gif-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'mute_gif'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*المتحركه بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(syria..'mute_gif'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_gif'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'mute_game'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_game'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الألعاب بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(syria..'mute_game'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الألعاب \n✓'
end
end
---------------Mute Inline-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'mute_inline'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الانلاين بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(syria..'mute_inline'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_inline'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الانلاين بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(syria..'mute_inline'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'mute_text'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الدرشه بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(syria..'mute_text'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الدردشه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_text'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الدردشه بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(syria..'mute_text'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الدردشه \n✓'
end
end
---------------Mute photo-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'mute_photo'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الصور بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(syria..'mute_photo'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الصور \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_photo'..msg.chat_id_)then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'mute_video'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الفيديو بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(syria..'mute_video'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الفيديو \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_video'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الفيديو يال��أكيد تــ✓ــم فتحها \n✓'
else 
redis:del(syria..'mute_video'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الفيديو \n✓'
end
end
---------------Mute Audio-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'mute_audio'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البصمات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(syria..'mute_audio'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل البصمات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_audio'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البصمات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(syria..'mute_audio'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح البصمات \n✓'
end
end
---------------Mute Voice-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if   redis:get(syria..'mute_voice'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الصوت بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(syria..'mute_voice'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الصوت \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_voice'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الصوت بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(syria..'mute_voice'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الصوت \n✓'
end
end
---------------Mute Sticker-------------------
...
if   redis:get(syria..'mute_sticker'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملصقات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(syria..'mute_sticker'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_sticker'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملصقات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(syria..'mute_sticker'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'mute_contact'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*جهات الاتصال بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(syria..'mute_contact'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_contact'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*جهات الاتصال بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(syria..'mute_contact'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'mute_forward'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التوجيه بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(syria..'mute_forward'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التوجيه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_forward'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'mute_location'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الموقع بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(syria..'mute_location'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الموقع \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_location'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الموقع بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(syria..'mute_location'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الموقع \n✓'
end
end
---------------Mute Document-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'mute_document'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملفات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(syria..'mute_document'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الملفات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_document'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملفات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(syria..'mute_document'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الملفات \n✓'
end
end
---------------Mute TgService-------------------
...
redis:set(syria..'mute_tgservice'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_tgservice'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الاشعارات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(syria..'mute_tgservice'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'mute_keyboard'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكيبورد بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(syria..'mute_keyboard'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'mute_keyboard'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكيبورد بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(syria..'mute_keyboard'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'lock_bots_by_kick'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البوتات بالطرد بالتاكيد تــ✓ــم قفله \n✓'
else
redis:set(syria..'lock_bots'..msg.chat_id_,true)
redis:set(syria..'lock_bots_by_kick'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'lock_bots_by_kick'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(syria..'lock_pin'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التثبيت بالفعل مقفل \n✓'
else
redis:set(syria..'lock_pin'..msg.chat_id_,true) 
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تـم قفل التثبيت \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(syria..'lock_pin'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التثبيت بالفعل مفتوح \n✓'
else 
redis:del(syria..'lock_pin'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تـم فتح التثبيت   \n✓'
end
end
